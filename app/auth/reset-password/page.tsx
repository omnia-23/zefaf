      ...
      <div className="mt-8">
        <div className="rounded-md bg-red-50 p-4">
          <div className="flex">
            ...
            <div className="mr-3">
              <h3 className="text-sm font-medium text-red-800">رمز إعادة تعيين كلمة المرور غير صالح أو منتهي الصلاحية</h3>
        ...
        {isSubmitted ? (
          <div className="rounded-md bg-green-50 p-4">
            <div className="flex">
              ...
              <div className="mr-3">
                <h3 className="text-sm font-medium text-green-800">تم إعادة تعيين كلمة المرور بنجاح</h3>

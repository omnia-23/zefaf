...
const JoinUs = () => {
    return (
        <section
            className="w-full h-[340px] py-20 relative bg-cover bg-center px-4"
            style={{
                background:
                    "url('/frontend/images/banner.png') no-repeat center",
            ...
            >
                <div className="absolute right-0 top-0 flex flex-col gap-6">
                    ...
                    <p className="text-white">
                        في كل عام يتواصل أكثر من 300 ألف عريس وعروس مع الشركات
                        المسجلة في زفاف.نت، أنت أيضاً يمكنك إضافة عملك والتواصل
                        مع العرسان بسهولة!
                    </p>

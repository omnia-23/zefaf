...
const OurServices = () => {
    const services = [
        {
            id: 1,
            icon: "/frontend/images/services-1.svg",
            title: "العروض",
            description:
        ...
        {
            id: 2,
            icon: "/frontend/images/services-2.svg",
            title: "الأسعار",
            description:
        ...
        {
            id: 3,
            icon: "/frontend/images/services-3.svg",
            title: "فريق العمل",
            description:
        ...
        <section className="container lg:px-8 mx-auto flex flex-col items-start gap-20 self-stretch py-[120px] text-black px-4">
            ...
            <div className="flex flex-col gap-6">
                ...
                <p className="text-[#555] text-right [leading-trim:both] [text-edge:cap] text-base font-normal leading-[normal]">
                    في عالم زفاف، نوفر لك فريق عمل محترف، أسعار تنافسية تناسب
                    الجميع، وعروض مميزة تضمن لك تجربة زفاف استثنائية بأعلى جودة.{" "}
                </p>
            </div>
